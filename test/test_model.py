...
class TestModel(unittest.TestCase):
    def test_init_model_default(self,):
        ...
        self.model = eg.m.GPModel(landmark_distances=model_input["landmark_distances"],
...
class TestReference(unittest.TestCase):
    def test_init_reference_tensor(self,):
        reference_input = ut.create_model_input()
        ref = eg.m.Reference(domain = reference_input["domain"],
                             landmarks = reference_input["landmarks"],
                             )
    def test_init_reference_numpy(self,):
        reference_input = ut.create_model_input()
        ref = eg.m.Reference(domain = reference_input["domain"].numpy(),
                             landmarks = reference_input["landmarks"].numpy(),
                             )

    def test_init_reference_pandas(self,):
        reference_input = ut.create_model_input()
        n_lmk = reference_input["landmarks"].shape[0]
        ref = eg.m.Reference(domain = reference_input["domain"].numpy(),
                             landmarks = pd.DataFrame(reference_input["landmarks"].numpy(),
    ...
    def test_init_reference_meta_numpy_1d(self,):
        reference_input = ut.create_model_input()
        ref = eg.m.Reference(domain = reference_input["domain"],
                             landmarks = reference_input["landmarks"],
    ...
    def test_init_reference_meta_numpy_2d(self,):
        reference_input = ut.create_model_input()
        meta = reference_input["meta"]
    ...
    def test_init_reference_meta_tensor_1d(self,):
        reference_input = ut.create_model_input()
        ref = eg.m.Reference(domain = reference_input["domain"],
                             landmarks = reference_input["landmarks"],
    ...
    def test_init_reference_meta_tensor_2d(self,):
        reference_input = ut.create_model_input()
        meta = reference_input["meta"]
        meta =  np.hstack((meta[:,np.newaxis],meta[:,np.newaxis]))
    ...
    def test_init_reference_meta_list_1d(self,):
        reference_input = ut.create_model_input()
